...
export default class EditBusinessUBO2 extends Component {
  ...
  getUserData = async () => {
    ...
    let uboData = userData.uboPerson.filter((item) => {
      return item.uboType === "ubo2"
    })
    ...
    if (uboData.length > 0) {
      ...
      this.setState({
        ...
        birthCountry: {
          value: data.Birthplace.Country,
          name: getCountryFromIso(data.Birthplace.Country),
          message: '',
          isValid: true,
        },
        addLine1: {
        ...
        country: {
          value: data.Nationality,
          name: getCountryFromIso(data.Nationality),
          message: '',
          isValid: true,
        },
        postalcode: {
        ...
        has75share: userData.has75share || false,
        has25share: userData.has25share || false,
      ...
      <View style={styles.container}>
        <SafeAreaView style={styles.safeVStyle}>
          <View style={GlobalStyles.topCustomHeader}>
            ...
            /> */}
            <HeaderLeft />
            <HeaderTitle title={'Third person owning more than 25%'} />
            <HeaderRight />
          </View>
  ...
  onAddUBO = async () => {
    ...
    uboPerson['uboType'] = "ubo2"

    uboPerson['has75share'] = has75share
    uboPerson['has25share'] = has25share
