...
import { fontLarge22, fontSmall14, fontSmall12 } from '../../utils/theme';
                ...
                >
                    <View
                        style={[
                            ...
                            { backgroundColor: Color.WhiteBlueLight, borderRadius: 26, paddingLeft: 16, paddingRight: 16, paddingBottom: 8, paddingTop: 8, }
                        ]}
                    >
                        <View renderMessageText={{ color: "green" }}>
                    ...
                    <View
                        style={[
                            styles.wrapper,
                            this.props.wrapperStyle, { alignItems: "flex-start" }
                        ]}
                    >
                        {this.renderTime()}
                    </View>
